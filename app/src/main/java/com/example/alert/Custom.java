...
public class Custom {
    ...
    private Control pListener, nListener;
    @ColorInt
    ...
    public static class Builder {
        ...
        public Builder onPositiveClicked(@Nullable Control pListener) {
            this.pListener = pListener;
            return this;
        }

        //set Negative listener
        public Builder onNegativeClicked(@Nullable Control nListener) {
